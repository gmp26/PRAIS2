  ...
  var jsonData = data.slice(1).map(function(row, i) {
	...
	$scope.gridOptions = {
	    columnDefs: [
	        ...
	        { field: 'Code', width: 90 },
	        { field: 'Operations', width: 130 },
	        { name: 'Deaths', field: 'Number of deaths', width: 100},
	        { name: 'Survivors', field: 'Number of survivors', width: 120 },
	        { field: 'Survival %', width: 120},
	        { name: 'Predicted %', field: 'predicted survival', width: 135},
	        { name: 'Actual/Predicted', field: 'Actual/ Predicted Survival Ratio', width: 170},
